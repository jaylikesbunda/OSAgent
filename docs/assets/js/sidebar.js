document.addEventListener('DOMContentLoaded', async function() {
  ...
  if (versionSelect) {
    ...
    const storedVersion = localStorage.getItem('osagent-doc-version');
    ...
    if (storedVersion && validVersions.includes(storedVersion) && storedVersion !== pathVersion) {
      ...
      localStorage.setItem('osagent-doc-version', storedVersion);
    ...
    versionSelect.addEventListener('change', async () => {
      ...
      localStorage.setItem('osagent-doc-version', newVersion);
